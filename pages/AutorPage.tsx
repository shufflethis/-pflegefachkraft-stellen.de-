  ...
  return (
    <div className="page-container autor-page">
      ...
      <section className="autor-detail">
        <h2>Thomas Sander</h2>
        <p className="autor-role">Gruender & Geschaeftsfuehrer von pflegefachkraft-stellen.de</p>

        <div className="autor-content">
          <p>
            Thomas Sander gruendete pflegefachkraft-stellen.de mit der Vision, den Recruiting-Prozess
            im Bereich Pflegefachkraft grundlegend zu verbessern. Als erfahrener Experte im
          ...
          <p>
            ...
            von Arbeitgebern als auch von Fachkraeften im Pflegefachkraft-Bereich.
          </p>

          <h3>Expertise</h3>
          <ul>
            <li>Pflegefachkraft & Branchenkenntnisse</li>
            <li>Personalwesen & Recruiting</li>
            <li>Digitale Jobportale & HR-Tech</li>
            <li>Arbeitsmarktanalysen im Pflegefachkraft-Bereich</li>
          </ul>
        </div>
      </section>
