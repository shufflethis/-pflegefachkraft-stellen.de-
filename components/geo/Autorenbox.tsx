  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von pflegefachkraft-stellen.de. Mit jahrelanger Erfahrung im
        Bereich Pflegefachkraft und Personalwesen hat er dieses spezialisierte Jobportal
        ins Leben gerufen, um Arbeitgeber und qualifizierte Fachkraefte zusammenzubringen.
      </p>
      <div className="autorenbox-links">
        <a href="https://pflegefachkraft-stellen.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
